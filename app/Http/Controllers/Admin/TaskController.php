...
class TaskController extends Controller
{
    public function index()
    {
        ...
        return view('admin.penugasan.index', compact('kanbanColumns', 'institutes'));
    }
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('actions', function ($task) {
                $url1 = route('admin.penugasan.edit', $task->id);
                $url2 = route('admin.penugasan.show', $task->id);
    ...
    public function show(Task $task): View
    {
        ...
        return view('admin.penugasan.show', compact('task'));
    }
}
