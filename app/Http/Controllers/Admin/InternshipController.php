...
class InternshipController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->editColumn('status_magang', function ($i) {
                $cls = $i->status_magang == 'Aktif' ? 'bg-success' : 'bg-secondary';
    ...
    public function exportPdf(Request $request)
    {
        ...
        $subtitle = [];
        if ($request->status_magang) $subtitle[] = 'Status: ' . $request->status_magang;
        if ($request->id_institute)  $subtitle[] = 'Instansi: ' . $data->first()?->permohonan?->institute?->nama_instansi;
