...
class PermohonanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('atasan.permohonan.tambah', compact('data'));
    }
    ...
    public function edit(Permohonan $application)
    {
        ...
        return view('atasan.permohonan.edit', compact('application', 'searchinstitutes'));
    }
    ...
    public function update(Request $request, Permohonan $application)
    {
        ...
        return redirect()->route('atasan.permohonan.index')
