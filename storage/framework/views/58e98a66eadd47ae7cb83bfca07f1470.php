...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <option value="Tidak Selesai"
                            <?php echo e(old('status_magang', $internship->status_magang) == 'Tidak Selesai' ? 'selected' : ''); ?>>Tidak Selesai
                        </option>
                    </select>
...
<?php echo $__env->make('admin.layoutsadmin.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\magang\resources\views/admin/internship/edit.blade.php ENDPATH**/ ?>