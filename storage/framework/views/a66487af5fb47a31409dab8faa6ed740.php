    ...
    <div class="container-fluid">
                ...
                <div class="row align-items-end p-3">
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="role" class="form-select">
                            ...
                            <?php $__currentLoopData = ['admin', 'pemagang', 'pembimbing', 'atasan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($st); ?>" <?php if(request('role') === $st): echo 'selected'; endif; ?>><?php echo e($st); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <?php $__currentLoopData = ['active', 'inactive']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table id="usersTable" class="display table table-striped table-hover align-middle datatable"
                    style="width:100%">
                    <thead>
                        <tr>
                            <th>ID</th>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        $(function() {
            ...
            // ===== Filter -> reload =====
            $('#filterForm').find('select').off('change').on('change', () => usersTable.ajax.reload());
...
<?php echo $__env->make('admin.layoutsadmin.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\proyek-manajemen-magang-upa-tik\resources\views/admin/users/index.blade.php ENDPATH**/ ?>