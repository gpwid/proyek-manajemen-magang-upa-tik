...
<head>
    ...
    <style>
        ...
        .pembimbing-mobile-sidebar-overlay.show { display: block; }
        ...
        .pembimbing-mobile-sidebar-overlay.show .pembimbing-mobile-sidebar-panel { transform: translateX(0); }

        /* Desktop: sidebar normal tampil; Mobile: pakai overlay */
        @media (max-width: 991.98px) {
            #pembimbingSidebarDesktopHolder { display: none !important; }
            #pembimbingOpenSidebarBtn { display: inline-flex !important; }
        }
        @media (min-width: 992px) {
            #pembimbingOpenSidebarBtn { display: none !important; }
        }
        ...
        .pembimbing-mobile-sidebar-panel .sidebar .sidebar-brand { margin-top: .25rem; }
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Footer (opsional) -->
            <?php echo $__env->renderWhen(View::exists('pembimbing.layoutspembimbing.footer'),'pembimbing.layoutspembimbing.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
...
<?php /**PATH C:\laragon\www\magang\resources\views/pembimbing/layoutspembimbing/main.blade.php ENDPATH**/ ?>