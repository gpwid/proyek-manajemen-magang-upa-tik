    ...
    <?php $__env->startSection('content'); ?>
        <div class="container-fluid">
            ...
            <div class="product-card shadow col-12 p-3">
                <form action="<?php echo e(route('admin.permohonan.update', $permohonan->id)); ?>" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tgl_surat"
                            value="<?php echo e(old('tgl_surat', optional($permohonan->tgl_surat)->format('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $searchinstansis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($x->id); ?>"
                                    <?php echo e(old('id_instansi', $permohonan->id_instansi) == $x->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tgl_mulai"
                            value="<?php echo e(old('tgl_mulai', optional($permohonan->tgl_mulai)->format('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tgl_selesai"
                            value="<?php echo e(old('tgl_selesai', optional($permohonan->tgl_selesai)->format('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pembimbing_sekolah"
                            value="<?php echo e(old('pembimbing_sekolah', $permohonan->pembimbing_sekolah)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kontak_pembimbing"
                            value="<?php echo e(old('kontak_pembimbing', $permohonan->kontak_pembimbing)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tgl_suratmasuk"
                            value="<?php echo e(old('tgl_suratmasuk', optional($permohonan->tgl_suratmasuk)->format('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="jenis_magang" class="form-control <?php $__errorArgs = ['jenis_magang'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__currentLoopData = ['Mandiri', 'MBKM', 'Sekolah']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($jm); ?>"
                                    <?php echo e(old('jenis_magang', $permohonan->jenis_magang) == $jm ? 'selected' : ''); ?>>
                                    <?php echo e($jm); ?>
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__currentLoopData = ['Proses', 'Aktif', 'Selesai', 'Ditolak']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($st); ?>"
                                    <?php echo e(old('status', $permohonan->status) == $st ? 'selected' : ''); ?>><?php echo e($st); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if($permohonan->file_permohonan): ?>
                            <div class="mb-2">
                                <a target="_blank" href="<?php echo e(Storage::url($permohonan->file_permohonan)); ?>">Lihat file saat
                                    ini</a>
                            </div>
                        <?php endif; ?>
...
<?php echo $__env->make('admin.layoutsadmin.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\proyek-manajemen-magang-upa-tik\resources\views/admin/permohonan/edit.blade.php ENDPATH**/ ?>