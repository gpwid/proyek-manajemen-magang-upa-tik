    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="<?php echo e(route('atasan.permohonan.index')); ?>" class="btn btn-secondary">Kembali</a>
            </div>
        </div>
...
<?php echo $__env->make('atasan.layoutsatasan.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\magang\resources\views/atasan/permohonan/show.blade.php ENDPATH**/ ?>