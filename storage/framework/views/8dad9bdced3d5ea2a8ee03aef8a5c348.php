...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="pembimbingSidebarDesktopHolder" class="d-none d-lg-block">
            <?php echo $__env->make('admin.layoutsadmin.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <?php echo $__env->make('admin.layoutsadmin.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <!-- End of Topbar -->
            ...
            <!-- Footer -->
            <?php echo $__env->make('admin.layoutsadmin.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <!-- End of Footer -->
    ...
    <div id="pembimbingMobileSidebarOverlay" class="pembimbing-mobile-sidebar-overlay" aria-hidden="true">
        <div class="pembimbing-mobile-sidebar-panel" role="dialog" aria-label="Menu">
            ...
            <?php echo $__env->make('pemagang.layoutspemagang.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
...
<?php /**PATH C:\wamp64\www\proyek-manajemen-magang-upa-tik\resources\views/admin/layoutsadmin/main.blade.php ENDPATH**/ ?>