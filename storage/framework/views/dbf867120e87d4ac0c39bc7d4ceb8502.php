        ...
        <div class="card-body">
            ...
            <div class="row align-items-end g-3 mb-3">
                ...
                <div class="col-md-3 text-lg-end">
                    ...
                    <a class="btn btn-primary px-3 shadow-sm w-100 w-lg-auto" href="<?php echo e(route('admin.instansi.create')); ?>">
...
$(function () {
    ...
    const table = $('#institute-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo route("admin.instansi.data"); ?>',
            data: d => {
    ...
    $('#btnExportExcel').on('click', function () {
        const qs = buildQuery();
        window.location = "<?php echo e(route('admin.instansi.export.excel')); ?>" + (qs ? ('?' + qs) : '');
    });

    $('#btnExportPdf').on('click', function () {
        const qs = buildQuery();
        window.location = "<?php echo e(route('admin.instansi.export.pdf')); ?>" + (qs ? ('?' + qs) : '');
    });
});
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layoutsadmin.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\proyek-manajemen-magang-upa-tik\resources\views/admin/instansi/index.blade.php ENDPATH**/ ?>