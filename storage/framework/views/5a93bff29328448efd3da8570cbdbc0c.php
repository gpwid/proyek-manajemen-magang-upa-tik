...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <form id="filterForm" method="GET" action="<?php echo e(route('atasan.permohonan.index')); ?>">
            <div class="card mb-4">
    ...
    <script>
        $(function() {
            ...
            const permohonanTable = $('#permohonanTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('atasan.permohonan.data')); ?>',
                    data: d => {
            ...
            $('#btnExportExcel').off('click').on('click', function(e) {
                ...
                window.location.href = '<?php echo e(route('atasan.permohonan.export.excel')); ?>' + (qs ? '?' + qs :
                    '');
            });
            $('#btnExportPdf').off('click').on('click', function(e) {
                e.preventDefault();
                const qs = buildQueryPermohonan();
                window.location.href = '<?php echo e(route('atasan.permohonan.export.pdf')); ?>' + (qs ? '?' + qs : '');
            });
        });
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('atasan.layoutsatasan.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\magang\resources\views/atasan/permohonan/index.blade.php ENDPATH**/ ?>