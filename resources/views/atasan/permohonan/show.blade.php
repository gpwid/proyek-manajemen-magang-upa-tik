    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="{{ route('atasan.permohonan.edit', $application->id) }}" class="btn btn-primary">
                    <i class="fa-solid fa-pen-to-square"></i> Edit
                </a>
                <a href="{{ route('atasan.permohonan.index') }}" class="btn btn-secondary">Kembali</a>

                @if ($application->status === 'Proses')
                    <form method="POST" action="{{ route('atasan.permohonan.status', $application) }}"
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="section-body p-3">
                                <a href="{{ route('atasan.peserta.create', ['permohonan_id' => $application->id]) }}"
