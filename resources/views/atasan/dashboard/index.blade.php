...
<script>
  ...
  var barChartOptions = {
    series: [{ name: 'Jumlah Pemagang', data: permohonanData.series }],
    chart: { type: 'bar', height: 350 },
    plotOptions: { bar: { horizontal: true, borderRadius: 4 } },
    dataLabels: { enabled: true },
    xaxis: { categories: permohonanData.labels, title: { text: 'Jumlah Permohonan' } },
    tooltip: { y: { formatter: val => val + " permohonan" } }
  };
