...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="atasanSidebarDesktopHolder" class="d-none d-lg-block">
            @include('atasan.layoutsatasan.sidebar')
        </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                @include('atasan.layoutsatasan.navbar')
                <!-- End of Topbar -->
            ...
            <!-- Footer (opsional) -->
            @includeWhen(View::exists('atasan.layoutsatasan.footer'),'atasan.layoutsatasan.footer')
