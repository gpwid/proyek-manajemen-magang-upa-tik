<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow topbar">
    ...
    {{-- Tombol buka Sidebar (muncul hanya di <992px via CSS) --}}
    <button id="atasanOpenSidebarBtn" class="btn btn-link d-lg-none rounded-circle mr-3" type="button" title="Menu">
        <i class="fa fa-bars"></i>
    </button>

    {{-- (Opsional) judul kecil --}}
    <h1 class="h6 mb-0 text-gray-800 d-none d-lg-inline">Panel Atasan</h1>
