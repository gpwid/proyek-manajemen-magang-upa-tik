...
<div class="container-fluid">
    ...
    <style>
      ...
      @media (max-width: 767.98px) {
        .row-split > .col-md-6 + .col-md-6 { border-left: 0; } /* hide di mobile */
      }
    </style>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form action="{{ route('admin.permohonan.update', $permohonan->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-3 row-split">
                        ...
                        <div class="col-md-6">
                            ...
                            <input
                                type="text"
                                name="no_surat"
                                value="{{ old('no_surat', $permohonan->no_surat ?? '') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            >
                                @foreach (['Mandiri','MBKM','Sekolah'] as $jm)
                                    <option value="{{ $jm }}" {{ old('jenis_magang', $permohonan->jenis_magang) == $jm ? 'selected' : '' }}>
                                        {{ $jm }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            >
                                @foreach (['Proses','Aktif','Selesai','Ditolak'] as $st)
                                    <option value="{{ $st }}" {{ old('status', $permohonan->status) == $st ? 'selected' : '' }}>
                                        {{ $st }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row g-3 row-split">
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($permohonan->file_permohonan)
                                <div class="mb-2">
                                    <a target="_blank" class="link-primary" href="{{ Storage::url($permohonan->file_permohonan) }}">
                                        Lihat file saat ini
                                    </a>
                                </div>
                            @endif
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($permohonan->file_suratbalasan)
                                <div class="mb-2">
                                    <a target="_blank" class="link-primary" href="{{ Storage::url($permohonan->file_suratbalasan) }}">
                                        Lihat file saat ini
                                    </a>
                                </div>
                            @endif
