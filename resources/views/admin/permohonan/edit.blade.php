    ...
    <div class="container-fluid">
        ...
        <div class="product-card shadow col-12 p-3">
            <form action="{{ route('admin.permohonan.update', $permohonan->id) }}" method="POST"
                ...
                <div class="mb-3">
                    <label>File Surat Balasan</label>
                    @if ($permohonan->file_suratbalasan)
                    <div class="mb-2">
                        <a target="_blank" href="{{ Storage::url($permohonan->file_suratbalasan) }}">Lihat file saat
                            ini</a>
                    </div>
                    @endif
                ...
                <div class="mb-3">
                    <label>Catatan</label>
                    <input type="text" name="catatan" value="{{ old('catatan', $permohonan->catatan) }}"
