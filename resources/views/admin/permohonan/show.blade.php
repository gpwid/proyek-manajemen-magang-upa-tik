...
@section('content')
    <div class="container-fluid">
        ...
        @php
            ...
            $hasPermohonan =
                filled($permohonan->file_permohonan) && Storage::disk('public')->exists($permohonan->file_permohonan);
            $hasSuratBalasan =
                filled($permohonan->file_suratbalasan) &&
                            ...
                            <div class="mt-4">
                                ...
                                <div class="section-body">
                                    ...
                                    <div class="col-12 ratio ratio-16x9">
                                        <iframe src="{{ Storage::url($application->file_permohonan) }}"
                                            title="PDF Reader" style="border:0; width:100%; height:70vh"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
