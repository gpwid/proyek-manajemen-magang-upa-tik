        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row align-items-end g-3 mb-3">
                    ...
                    {{-- Tombol Tambah (ratakan kanan di layar lebar) --}}
                    <div class="col-md-3 text-lg-end">
                        <label class="form-label d-none d-lg-block">&nbsp;</label>
                        <a class="btn btn-primary px-3 shadow-sm w-100 w-lg-auto"
                            href="{{ route('admin.pembimbing.create') }}">
                ...
                <!-- Tabel -->
                <table id="pembimbing-table" class="display table table-striped table-hover align-middle"
                    style="width:100%">
                    <thead>
                        <tr>
                            <th>No.</th>
...
<style>
    ...
    #pembimbing-table thead th {
        background: #f8fafc;
        font-weight: 700;
        border-bottom: 1px solid #e9ecef;
    }

    #pembimbing-table tbody td {
        vertical-align: middle;
    }

    #pembimbing-table.table-hover tbody tr:hover {
        background: #f6f9ff;
    }
    ...
    <script>
        $(function() {
            ...
            const table = $('#pembimbing-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('admin.pembimbing.data') !!}',
                    data: d => {
            ...
            $('#btnExportExcel').on('click', function() {
                const qs = buildQuery();
                window.location = "{{ route('admin.pembimbing.export.excel') }}" + (qs ? ('?' + qs) : '');
            });

            $('#btnExportPdf').on('click', function() {
                const qs = buildQuery();
                window.location = "{{ route('admin.pembimbing.export.pdf') }}" + (qs ? ('?' + qs) : '');
            });
        });
    </script>
@endsection
