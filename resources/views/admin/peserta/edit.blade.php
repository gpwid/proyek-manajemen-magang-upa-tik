...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow title-section-content col-12 p-4">
            ...
            <form action="{{ route('admin.peserta.update', $participant->id) }}" method="POST" class="needs-validation"
                novalidate>
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-3 row-split">
                        ...
                        <div class="col-md-6">
                            <label for="nik" class="form-label fw-semibold">NIK <span
                                    class="text-danger">*</span></label>
                            <input id="nik" type="text" {{-- text agar 0 depan tidak hilang --}} name="nik"
                                value="{{ old('nik', $participant->nik) }}"
                                class="form-control @error('nik') is-invalid @enderror" placeholder="16 digit"
                                maxlength="16" inputmode="numeric" pattern="[0-9]*" required>
                            @error('nik')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
               ...
               ========================= --}}
                <div class="mb-3">
                    ...
                    <div class="row g-3 row-split">
                        {{-- NISN/NIM --}}
                        <div class="col-md-6">
                            <label for="nisnim" class="form-label fw-semibold">NISN/NIM </label>
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="jenis_kelamin" name="jenis_kelamin"
                                ...
                                <option value="L"
                                    {{ old('jenis_kelamin', $participant->jenis_kelamin) == 'L' ? 'selected' : '' }}>
                                    Laki-laki</option>
                                <option value="P"
                                    {{ old('jenis_kelamin', $participant->jenis_kelamin) == 'P' ? 'selected' : '' }}>
                                    Perempuan</option>
                            </select>
                            @error('jenis_kelamin')
                                <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <select id="institute_id" name="institute_id"
                                ...
                                @foreach ($institutes as $institute)
                                    <option value="{{ $institute->id }}"
                                        {{ old('institute_id', $participant->institute_id) == $institute->id ? 'selected' : '' }}>
                    ...
                    <div class="row g-3 row-split mt-0">
                        {{-- Tahun Aktif --}}
                        <div class="col-md-6">
                            <label for="tahun_aktif" class="form-label fw-semibold">Tahun Aktif <span
                                    class="text-danger">*</span></label>
                            <input id="tahun_aktif" type="text" {{-- text agar fleksibel --}} name="tahun_aktif"
               ...
               ========================= --}}
                <div class="mb-3">
                    ...
                    <div class="row g-3 row-split">
                        {{-- Kontak Peserta --}}
                        <div class="col-md-6">
                            <label for="kontak_peserta" class="form-label fw-semibold">Kontak Peserta <span
                                    class="text-danger">*</span></label>
                            <input id="kontak_peserta" type="text" name="kontak_peserta"
                                ...
                                placeholder="Nomor HP/WA (08xxxxxxxxxx)" maxlength="20" required>
