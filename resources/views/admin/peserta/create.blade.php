        ...
        <form action="{{ route('admin.peserta.store') }}" method="POST" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
                ...
                <div class="row g-3 row-split">
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            type="text" {{-- pakai text agar 0 depan tidak hilang --}}
                            name="nik"
                            value="{{ old('nik') }}"
            ...
            <div class="mb-3">
                ...
                <div class="row g-3 row-split mt-0">
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            type="text"  {{-- text agar fleksibel (angkatan 2023/2024, dsb) --}}
                            name="tahun_aktif"
            ...
            <div class="mb-3">
                ...
                <div class="row g-3 row-split">
                    ...
                    {{-- (Kosong) ruang untuk keseimbangan layout, bisa diisi field lain nanti --}}
                    <div class="col-md-6">
                        {{-- Placeholder kolom kanan (optional). Kosong agar visual tetap seimbang. --}}
                    </div>
                </div>
            </div>
